  ...
  return (
    <header className="bg-gray-50 min-h-screen flex flex-col justify-center">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:py-10 lg:px-8 flex flex-col sm:flex-row items-center">
        ...
        <div className="sm:w-2/5 w-full flex justify-center sm:items-end mb-6 sm:mb-0 order-1 sm:order-none">
          <img
            src={profileImage1}
            alt="Preet Bairwa"
        ...
        {/* Text Section */}
        <div className="sm:w-3/5 mb-8 sm:mb-0 text-center sm:text-left sm:pl-6 flex flex-col justify-center order-2 sm:order-none">
